...
In the Java EE 8 environment, all _component classes supporting injection_, as defined by the Java EE 8 platform specification, may inject beans via the dependency injection service.
